...
/* CaliSubject                                               */
/* ----------------------------------------------------------*/
BDAQINL int32                  CaliSubject_getDescription(CaliSubject *obj, int32 size, wchar_t buffer[])                               { return DAQFN_TTT(DNLAPI_BASE, 105, int32, int32, wchar_t *)(obj, size, buffer);}  
BDAQINL int32                  CaliSubject_getInstruction(CaliSubject *obj, int32 size, wchar_t buffer[])                               { return DAQFN_TTT(DNLAPI_BASE, 106, int32, int32, wchar_t *)(obj, size, buffer);}    
BDAQINL int32                  CaliSubject_getTargetRange(CaliSubject *obj, int32 size, wchar_t buffer[])                               { return DAQFN_TTT(DNLAPI_BASE, 107, int32, int32, wchar_t *)(obj, size, buffer);}    
BDAQINL CaliState              CaliSubject_getCurrentState(CaliSubject *obj,double *value, int32 *codeCount, int32 adjCode[])           { return DAQFN_TTTT(DNLAPI_BASE, 108, CaliState, double *, int32 *, int32 *)(obj, value, codeCount, adjCode);}    
BDAQINL void                   CaliSubject_getAdjCodeRange(CaliSubject *obj, int32 *lower, int32 *upper)                                { return DAQFN_VTT(DNLAPI_BASE, 109, int32 *, int32 *)(obj, lower, upper);}    
...
BDAQINL ErrorCode              CaliSubject_ManualSetAdjCode(CaliSubject *obj, int32 code)                                               { return DAQFN_ET(DNLAPI_BASE, 112, int32)(obj, code);}    

/* ----------------------------------------------------------*/
/* CaliSection                                               */
/* ----------------------------------------------------------*/
BDAQINL int32                  CaliSection_getTypeName(CaliSection *obj, int32 size, wchar_t buffer[])                                  { return DAQFN_TTT(DNLAPI_BASE, 113, int32, int32, wchar_t *)(obj, size, buffer);}      
BDAQINL int32                  CaliSection_getDescription(CaliSection *obj, int32 size, wchar_t buffer[])                               { return DAQFN_TTT(DNLAPI_BASE, 114, int32, int32, wchar_t *)(obj, size, buffer);}   
BDAQINL int32                  CaliSection_getInstruction(CaliSection *obj, int32 size, wchar_t buffer[])                               { return DAQFN_TTT(DNLAPI_BASE, 116, int32, int32, wchar_t *)(obj, size, buffer);}    
...
BDAQINL void                   CaliSection_BatchTerminate(CaliSection *obj)                                                             { return DAQFN_VV(DNLAPI_BASE, 118)(obj);                                        }     
BDAQINL void                   CaliSection_SaveAdjustCodes(CaliSection *obj)                                                            { return DAQFN_VV(DNLAPI_BASE, 119)(obj);                                        }    

/* ----------------------------------------------------------*/
/* CaliSolution                                              */
/* ----------------------------------------------------------*/
BDAQINL int32                  CaliSolution_getTypeName(CaliSolution *obj, int32 size, wchar_t buffer[])                                { return DAQFN_TTT(DNLAPI_BASE, 120, int32, int32, wchar_t *)(obj, size, buffer);}      
BDAQINL int32                  CaliSolution_getDescription(CaliSolution *obj, int32 size, wchar_t buffer[])                             { return DAQFN_TTT(DNLAPI_BASE, 121, int32, int32, wchar_t *)(obj, size, buffer);}  
BDAQINL int32                  CaliSolution_getInstruction(CaliSolution *obj, int32 size, wchar_t buffer[])                             { return DAQFN_TTT(DNLAPI_BASE, 122, int32, int32, wchar_t *)(obj, size, buffer);}    
BDAQINL int8 *                 CaliSolution_getAuxiliaryImage(CaliSolution *obj, int32 *size)                                           { return DAQFN_TT(DNLAPI_BASE,  123, int8 *, int32 *)(obj, size);                }    
BDAQINL IArray *               CaliSolution_getSections(CaliSolution *obj)                                                              { return DAQFN_TV(DNLAPI_BASE,  124, IArray *)(obj);                             }   
...
BDAQINL IArray *               CalibrationCtrl_getSolutions(CalibrationCtrl *obj)                                                       { return DAQFN_TV(DNLAPI_BASE, 125, IArray *)(obj);                   }
/*creator*/
...
{
public:
   int32     getDescription(int32 size, wchar_t *buffer)          { return CaliSubject_getDescription(this, size, buffer);  }
   int32     getInstruction(int32 size, wchar_t *buffer)          { return CaliSubject_getInstruction(this, size, buffer);  }
   int32     getTargetRange(int32 size, wchar_t *buffer)          { return CaliSubject_getTargetRange(this, size, buffer);  }
   CaliState getCurrentState(double *value, int32 *codeCount, int32 adjCode[]) { return CaliSubject_getCurrentState(this, value, codeCount, adjCode); }
   void      getAdjCodeRange(int32 *lower, int32 *upper)                       { return CaliSubject_getAdjCodeRange(this, lower, upper);              }
   ...
   ErrorCode ManualSetAdjCode(int32 code)                         { return CaliSubject_ManualSetAdjCode(this, code); }
private:
...
{
public:
   int32               getTypeName(int32 size, wchar_t *buffer)    { return CaliSection_getTypeName(this, size, buffer);       }
   int32               getDescription(int32 size, wchar_t *buffer) { return CaliSection_getDescription(this, size, buffer);    }
   int32               getInstruction(int32 size, wchar_t *buffer) { return CaliSection_getInstruction(this, size, buffer);  }
   ...
   void                BatchTerminate(void)                        { return CaliSection_BatchTerminate(this);                  }
   void                SaveAdjustCodes(void)                       { return CaliSection_SaveAdjustCodes(this);                 }
...
{
public:
   int32               getTypeName(int32 size, wchar_t *buffer)    { return CaliSolution_getTypeName(this, size, buffer);       }
   int32               getDescription(int32 size, wchar_t *buffer) { return CaliSolution_getDescription(this, size, buffer);    }
   int32               getInstruction(int32 size, wchar_t *buffer) { return CaliSolution_getInstruction(this, size, buffer);    }
   int8 *              getAuxiliaryImage(int32 *size)              { return CaliSolution_getAuxiliaryImage(this, size);         }
